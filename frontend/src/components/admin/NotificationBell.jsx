...
/**
 * Bell + dropdown drawer for admin notifications.
 *
 * Lives in the admin header. Polling is driven by the notification store's
 * `start()` method (called from `AdminLayout`); this component only reads
  ...
  useEffect(() => {
    ...
    const onDown = (e) => {
      if (drawerRef.current && !drawerRef.current.contains(e.target)) {
        useNotificationStore.setState({ open: false });
      }
    };
